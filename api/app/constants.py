...
HLS_LONGEST_SIDE = 1024 # how many pixels the longest side of the rescaled image of an oxygenator should be before running
                        # detection algorithm
...
RANSAC_NUM_INLIERS = 240    # number of inliers required to consider the object as correct fit
